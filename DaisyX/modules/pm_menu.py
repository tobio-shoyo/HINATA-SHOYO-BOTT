...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/tobio-shoyo/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/CROWS_CLIPPED"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/HINATA_ROBOT_SUPPORT"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Hinata Shoyo to your group",
            url=f"https://telegram.me/INTERVIER_ROBOT?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/INTERVIER_ROBOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
