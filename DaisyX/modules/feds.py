...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means Shoyo will wait file message from you. Type /cancel to leave from it.
