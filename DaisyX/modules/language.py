...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://t.me/HINATA_ROBOT_SUPPORT"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Shoyo's localization feature! You can also <a href='https://crowdin.com/project/DaisyXx'>contribute</a> for improving localization in Shoyo!
...
Shoyo will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
